 ...
 * This version is for board 1.6 of the BETA release.
...
int g = 0;
int b = 0;
int brightness_default = 50;  //31,32,33,35 36, 25 cause error
...
void setledcolor(int color, int index) {
  ...
  int temp_color = color * color_factor;
    
  if(temp_color <= temp_value) {
    r = 255 - temp_color;
    b = temp_color;
    g = 0;
  } 
  ...
  strip.setPixelColor((index * 2) + 1, strip.Color(255,255,255));
